...
const TopPage = () => {
  ...
  return (
    <div className={styles.top}>
      ...
      <div>
        <Link to="/rooms/000000">
          <button className={styles.playButton}>ランダムな人とプレイ</button>
        </Link>

        <button onClick={() => setDialog(true)} className={styles.playButton}>
          合言葉でプレイ
        </button>
      </div>
